...
""".trimIndent())
    ...
    // ─────────────────────────────────────────────────────────────────────
    // Phase 5.1 — std.string real implementations (inline LLVM IR)
    // ─────────────────────────────────────────────────────────────────────

    private fun emitPhase5StringRuntime() {
        rtFns.appendLine("""
...
""".trimIndent())
    ...
    // ─────────────────────────────────────────────────────────────────────
    // Phase 5.2 — std.collections real implementations (inline LLVM IR)
    ...
    private fun emitPhase5CollectionsRuntime() {
        rtFns.appendLine("""
...
""".trimIndent())
    ...
    // ─────────────────────────────────────────────────────────────────────
    // Phase 5.3 — std.io real implementations (inline LLVM IR)
    // File operations wrap libc FILE* as opaque i8*.
    // ─────────────────────────────────────────────────────────────────────

    private fun emitPhase5IoRuntime() {
        rtFns.appendLine("""
; ── Phase 5.3: File I/O operations ──────────────────────────────────────────
