...
class NordvestSymbolIndex : FileBasedIndexExtension<String, String>() {
     ...
     */
    private fun extractSymbols(text: CharSequence): List<Pair<String, String>> {
    ...
    private fun extractDeclFromLine(line: String): Pair<String, String>? {
